...
// GenerateClientConfig 生成 ClientConfig 并写入 指定路径 默认.sovereign/config.yaml
func GenerateClientConfig(
	...
	// 写入配置文件到当前目录的 .sovereign/client_config.yaml
	configDir := filepath.Dir(load.ExpandHomeDir(runFlags.SovereignConfigPath))
